...
public class MyActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNavigationDrawerFragment = (NavigationDrawerFragment)
                getSupportFragmentManager().findFragmentById(R.id.drawer_layout); //navigation_drawer
        mTitle = getTitle();

        // Set up the drawer.
        mNavigationDrawerFragment.setUp(
                R.id.drawer_layout, //navigation_drawer
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch(position) {
            ...
            case 1:
                ...
                break;
            case 2:
                objFragment = new MyGamesFragment();
                break;
            case 3:
                objFragment = new MyParksFragment();
                break;
            case 4:
